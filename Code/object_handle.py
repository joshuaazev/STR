...
class ObjectHandle:
   ...
   def __init__(self, clientID, robotname):
      ...
      ######## Robô:
      erro, self.robot = sim.simxGetObjectHandle(self.clientID, self.robotname, sim.simx_opmode_oneshot_wait)
      #erro, self.s_base = sim.simxGetObjectHandle(self.clientID, 'youBot', sim.simx_opmode_blocking)

      ####### OmniWheels:
      erro, self.omniWheel_direita_frente = sim.simxGetObjectHandle(self.clientID, 'swedishWheel_fr', sim.simx_opmode_blocking)
      erro, self.omniWheel_direita_atras = sim.simxGetObjectHandle(self.clientID, 'swedishWheel_rr', sim.simx_opmode_blocking)
      erro, self.omniWheel_esquerda_frente = sim.simxGetObjectHandle(self.clientID, 'swedishWheel_fl', sim.simx_opmode_blocking)
      erro, self.omniWheel_esquerda_atras = sim.simxGetObjectHandle(self.clientID, 'swedishWheel_rl', sim.simx_opmode_blocking)
      erro, self.junta_deslizadora_df = sim.simxGetObjectHandle(self.clientID, 'slippingJoint_fr', sim.simx_opmode_blocking)
      erro, self.junta_deslizadora_da = sim.simxGetObjectHandle(self.clientID, 'slippingJoint_rr', sim.simx_opmode_blocking)
      erro, self.junta_deslizadora_ef = sim.simxGetObjectHandle(self.clientID, 'slippingJoint_fl', sim.simx_opmode_blocking)
      erro, self.junta_deslizadora_ea = sim.simxGetObjectHandle(self.clientID, 'slippingJoint_rl', sim.simx_opmode_blocking)
      erro, self.rolling_joint_fr = sim.simxGetObjectHandle(self.clientID, 'rolling_joint_fr', sim.simx_opmode_blocking)
      erro, self.rolling_joint_rr = sim.simxGetObjectHandle(self.clientID, 'rolling_joint_rr', sim.simx_opmode_blocking)
      erro, self.rolling_joint_fl = sim.simxGetObjectHandle(self.clientID, 'rolling_joint_fl', sim.simx_opmode_blocking)
      erro, self.rolling_joint_rl = sim.simxGetObjectHandle(self.clientID, 'rolling_joint_rl', sim.simx_opmode_blocking)
      ...
      self.cubo_garra_frente = [0, 'handle'] #0 se estiver vazio, se tiver cubo botar o número dele
      self.cubo_garra_costas = [0, 'handle'] #0 se estiver vazio, se tiver cubo botar o número dele
